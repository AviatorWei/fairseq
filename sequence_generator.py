...
class SequenceGenerator(object):
    ...
    def generate(
        ...
        **kwargs
        ...
        '''
        print("***Generator Input Detection***")
        print(encoder_input.keys())
        #print(type(src_tokens))
        #print(type(src_lengths))
        print(src_tokens.size())
        print(src_lengths)
        print("padded sentence token:")
        print(src_tokens[0])
        print(src_tokens[-1])
        print("****Generator Detection End****")
        print()
        '''
        ...
        """
        print("***Encoder Output Detection***")
        assert (len(encoder_outs) == 1)
        batch = encoder_outs[0]
        print(batch.keys())
        for k in batch.keys():
            print(k)
            print(len(batch[k]))
        ...
        print("*****Output Detection End*****")
        """
        outbuf = copy.deepcopy(encoder_outs)
